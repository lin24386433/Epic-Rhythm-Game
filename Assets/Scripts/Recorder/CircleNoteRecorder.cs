	...
	*/
	...
	private void Update()
	{
		...
		if (indexOfNextNote < singleNote.Length && singleNote[indexOfNextNote] < RecordConductor.instance.beatToShow)
		{
			...
			RecorderNote musicNote = ((GameObject)Instantiate(RecordConductor.instance.musicCircleNotePrefab, startPos.transform.position, startPos.transform.rotation)).GetComponent<RecorderNote>();
